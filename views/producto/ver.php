              ...
              <!--CONTENIDO PRINCIPAL-->
               <div class="col-12 col-lg-9 caja-principal">
                  ...
                  <div class="row mb-3 pt-3">
                    <div class="col col-producto-ver my-3 d-flex flex-column justify-content-center align-items-center">
                        <?php if($product->imagen != null): ?>
                           <a href="<?=base_url?>producto/ver&id=<?=$product->id?>">
                             <img src="<?=base_url?>uploads/images/<?=$product->imagen?>" class="img-fluid img-producto" width="170">
                           </a>
                        <?php else: ?>
                          <a href="<?=base_url?>producto/ver&id=<?=$product->id?>">
                             <img src="<?=base_url?>assets/img-camisa-2.png" class="img-fluid img-producto" width="165">
                           </a>
                        <?php endif; ?>

                        <p class="desc-producto my-1"><?= $product->descripcion ?></p>
                        <p class="my-1"><strong><?= $product->precio ?>$</strong></p>
                        <a href="<?=base_url?>carrito/add&id=<?=$product->id?>" class="btn boton-enviar btn-block mt-1">Comprar</a>
                      </div>
                   </div>
  
                <div class="d-flex flex-column justify-content-center align-items-center">
                <img src="<?=base_url?>assets/img-logo-toronto.png" class="img-fluid mb-1" width="150">
                </div> 
